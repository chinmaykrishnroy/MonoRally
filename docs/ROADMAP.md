...
| **v1.2.7** | Current Release | Fairness & Critical Stability Patch | Swept continuous collision detection, jitter-proof input sequencing, error UI |
| **v1.3.0** | Planned | Distributed Data Foundation | PostgreSQL, Redis, database migrations, repository layer, zero local file persistence |
